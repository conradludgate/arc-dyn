//! This module provides [`PinQueue`] support.
//!
//! # Example
//!
...
//!
//! // spawn()
//! let task1 = ThinArc::pin(Node::new(async { println!("1"); }));
//! QUEUE.lock().unwrap().push_back(task1).unwrap();
//!
//! let task2 = ThinArc::pin(Node::new(async { println!("2"); }));
//! QUEUE.lock().unwrap().push_back(task2).unwrap();
//!
//! // waker
//! impl arc_dyn::pin_queue::ThinWake for DynNode {
